...
# The installer file (installer/yakk_install/dependencies.yaml) is a copy.
#
...
INSTALLER_DEPS="$PROJECT_ROOT/installer/yakk_install/dependencies.yaml"
...
echo "   Target: installer/yakk_install/dependencies.yaml"
