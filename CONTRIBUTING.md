# Contributing to Yakk

Thank you for your interest in contributing to Yakk. This guide will help you get started with development.
...
1. **Fork and clone the repository**
   ...
   - Click **Fork** at https://github.com/mbailey/yakk
   - Clone your fork:
   ```bash
   git clone https://github.com/YOUR-USERNAME/yakk.git
   cd yakk
   ```
...
5. Push to your fork and create a pull request
   ...
   ```
   Then open a PR from your fork to `mbailey/yakk`
...
Debug recordings are saved to `~/.yakk/audio/`
